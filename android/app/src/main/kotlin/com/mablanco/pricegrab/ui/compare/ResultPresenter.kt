 ...
 *
 * - `perUnitDelta` — the absolute savings in **display** units (per kg, per L,
 *   or per piece), e.g. `"1"` for a base delta of 0.001 €/g. Up to six
 ...
 * a tie, no outcome has been computed yet, or [dimension] is unknown.
 */
object ResultPresenter {
    ...
    private fun format(
        ...
        val displayDelta = perUnitDelta.multiply(dimension.displayUnitScale)
        return SavingsPresentation(
